...
#+begin_src emacs-lisp :tangle yes
  ...
  (use-package lsp-haskell
    ...
    :config
    (push 'haskell lsp-enabled-clients))
#+end_src
**** proof
#+begin_src emacs-lisp :tangle yes
    ...
    (circe-network-options
     `(
       ("Libera"
        ...
        :port 6697
        :tls t
        :nick ,user-real-login-name
        :sasl-username ,user-real-login-name
       ...
       ("OFTC"
        ...
        :channels (:after-auth "#pipewire" "#voidlinux-ppc" "#alpine-linux" "#pwmt"
                               "#git-annex")))))
